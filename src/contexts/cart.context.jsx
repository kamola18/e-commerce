...
const removeCartItem = (cartItems, cardItemToRemove) => {
    ...
    if(cardItemToRemove.quantity === 1) {
...
const clearCarItem = (cartItems, cardItemToClear) => cartItems.filter(
    (cartItem) => cartItem.id !== cardItemToClear.id);
...
export const CartProvider = ({children}) => {
    ...
    //when cartItems dependency array changes recalculate useEffect
    useEffect(() => {
    ...
    const clearItemFromCart = (cardItemToClear) => {
        setCartItems(clearCarItem(cartItems,cardItemToClear));
    }  
